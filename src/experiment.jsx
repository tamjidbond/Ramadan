...
import {
  ...
  Coffee, Utensils, Award, Bell, Info, Check, Compass,
  Map, Globe, SunDim, CloudRain, CloudSnow, CloudLightning,
  CloudDrizzle, Eye, Gauge, Sunrise as SunriseIcon,
  Sunset as SunsetIcon, Navigation, Anchor, Waves,
  Moon as MoonIcon, Umbrella, Battery, Wifi, WifiOff,
...
const PRAYERS = [
  ...
  { name: "সূর্যোদয়", key: "Sunrise", icon: "🌅", timeName: "সূর্যোদয়", priority: 2 },
  { name: "যোহর", key: "Dhuhr", icon: "☀️", timeName: "যোহর", priority: 3 },
  { name: "আসর", key: "Asr", icon: "🌤️", timeName: "আসর", priority: 4 },
  { name: "মাগরিব", key: "Maghrib", icon: "🌇", timeName: "ইফতার", priority: 5 },
  { name: "ইশা", key: "Isha", icon: "🌌", timeName: "ইশা", priority: 6 }
];

const ADDITIONAL_PRAYERS = [
  { name: "তাহাজ্জুদ", key: "Tahajjud", icon: "🌟", timeName: "তাহাজ্জুদ", minutesFromFajr: -90 },
  { name: "ইশরাক", key: "Ishraq", icon: "☀️", timeName: "ইশরাক", minutesFromSunrise: 20 },
  { name: "চাশত", key: "Chasht", icon: "🌤️", timeName: "চাশত", minutesFromSunrise: 45 },
  { name: "যাওয়াল", key: "Zawal", icon: "⚡", timeName: "যাওয়াল", minutesBeforeDhuhr: 5 }
];

const POPULAR_CITIES = [
  { bn: "ঢাকা", en: "Dhaka", lat: 23.8103, lon: 90.4125, population: "২.১ কোটি", timezone: "Asia/Dhaka" },
  { bn: "চট্টগ্রাম", en: "Chittagong", lat: 22.3569, lon: 91.7832, population: "৮৫ লক্ষ", timezone: "Asia/Dhaka" },
  { bn: "খুলনা", en: "Khulna", lat: 22.8456, lon: 89.5403, population: "৬৫ লক্ষ", timezone: "Asia/Dhaka" },
  { bn: "রাজশাহী", en: "Rajshahi", lat: 24.3745, lon: 88.6042, population: "৫৫ লক্ষ", timezone: "Asia/Dhaka" },
  { bn: "সিলেট", en: "Sylhet", lat: 24.8949, lon: 91.8687, population: "৫০ লক্ষ", timezone: "Asia/Dhaka" },
  { bn: "বরিশাল", en: "Barisal", lat: 22.7010, lon: 90.3535, population: "৪০ লক্ষ", timezone: "Asia/Dhaka" },
  { bn: "রংপুর", en: "Rangpur", lat: 25.7439, lon: 89.2752, population: "৪৫ লক্ষ", timezone: "Asia/Dhaka" },
  { bn: "ময়মনসিংহ", en: "Mymensingh", lat: 24.7471, lon: 90.4203, population: "৫২ লক্ষ", timezone: "Asia/Dhaka" },
  { bn: "কুমিল্লা", en: "Comilla", lat: 23.4607, lon: 91.1809, population: "৬০ লক্ষ", timezone: "Asia/Dhaka" },
  { bn: "নারায়ণগঞ্জ", en: "Narayanganj", lat: 23.6238, lon: 90.5000, population: "৪২ লক্ষ", timezone: "Asia/Dhaka" }
];

const METHODS = [
  { id: 1, name: "ইসলামিক সায়েন্স ইউনিভার্সিটি, করাচী", accuracy: "±১ মিনিট", region: "দক্ষিণ এশিয়া", fajrAngle: 18, ishaAngle: 18 },
  { id: 2, name: "ইসলামিক সোসাইটি অফ নর্থ আমেরিকা (ISNA)", accuracy: "±২ মিনিট", region: "উত্তর আমেরিকা", fajrAngle: 15, ishaAngle: 15 },
  { id: 3, name: "মুসলিম ওয়ার্ল্ড লীগ", accuracy: "±১ মিনিট", region: "ইউরোপ/এশিয়া", fajrAngle: 18, ishaAngle: 17 },
  { id: 4, name: "উম্মুল কুরা, মক্কা", accuracy: "±২ মিনিট", region: "সৌদি আরব", fajrAngle: 18.5, ishaAngle: 90 },
  { id: 5, name: "ইজিপশিয়ান জেনারেল অথরিটি", accuracy: "±২ মিনিট", region: "মিশর/আফ্রিকা", fajrAngle: 19.5, ishaAngle: 17.5 },
  { id: 7, name: "তেহরান ইউনিভার্সিটি", accuracy: "±৩ মিনিট", region: "ইরান", fajrAngle: 17.7, ishaAngle: 14 },
  { id: 8, name: "গুলফ রিজিয়ন", accuracy: "±২ মিনিট", region: "উপসাগরীয় অঞ্চল", fajrAngle: 18.2, ishaAngle: 18.2 },
  { id: 9, name: "কুয়েত", accuracy: "±১ মিনিট", region: "কুয়েত", fajrAngle: 18, ishaAngle: 17.5 },
  { id: 10, name: "কাতার", accuracy: "±১ মিনিট", region: "কাতার", fajrAngle: 18, ishaAngle: 18 },
  { id: 12, name: "মজলিস তানজিমুল", accuracy: "±১ মিনিট", region: "সিঙ্গাপুর", fajrAngle: 20, ishaAngle: 18 },
  { id: 14, name: "ধনেশ্বরী", accuracy: "±১ মিনিট", region: "বাংলাদেশ", fajrAngle: 18.5, ishaAngle: 18 }
];
...
const ARABIC_MONTHS = ['মুহররম', 'সফর', 'রবিউল আউয়াল', 'রবিউস সানি', 'জমাদিউল আউয়াল', 'জমাদিউস সানি', 'রজব', 'শাবান', 'রমজান', 'শাওয়াল', 'জ্বিলকদ', 'জ্বিলহজ'];
...
const formatTimeDifference = (seconds) => {
  ...
  if (hours > 0) {
    return `${toBengaliNumber(hours)} ঘন্টা ${toBengaliNumber(minutes)} মিনিট ${toBengaliNumber(secs)} সেকেন্ড`;
  } else if (minutes > 0) {
    return `${toBengaliNumber(minutes)} মিনিট ${toBengaliNumber(secs)} সেকেন্ড`;
  } else {
...
const calculateAdditionalPrayers = (timings) => {
  ...
  if (sunrise && dhuhr) {
    const ishraqSeconds = Math.min(sunrise.totalSeconds + 20 * 60, dhuhr.totalSeconds - 30 * 60);
  ...
  if (sunrise && dhuhr) {
    const chashtSeconds = Math.min(sunrise.totalSeconds + 45 * 60, dhuhr.totalSeconds - 15 * 60);
  ...
  if (sunrise && dhuhr) {
    const zawalSeconds = Math.max(sunrise.totalSeconds + 30 * 60, dhuhr.totalSeconds - 5 * 60);
...
const Card = ({ children, className = "", glow = false, onClick, elevation = "medium" }) => {
...
const AccuracyBadge = ({ accuracy }) => {
  ...
  return (
    <span className="accuracy-badge" style={{ backgroundColor: getColor() + '20', color: getColor() }}>
...
export default function RamadanUltra() {
  ...
  const [seharIftar, setSeharIftar] = useState(null);
  const [history, setHistory] = useState([]);
  const [accuracy, setAccuracy] = useState({ status: 'high', message: 'নির্ভুল সময়' });
  ...
  useEffect(() => {
    const loadSavedData = () => {
      try {
        const saved = localStorage.getItem('ramadan-ultra-v2');
        if (saved) {
          ...
          setHijriAdjustment(data.hijriAdjustment || 0);
          
          if (data.lastCity) {
            setCity(data.lastCity.bn);
            setCityEn(data.lastCity.en);
            // অটো লোড করবেন না, ইউজার ইন্টারঅ্যাকশন প্রয়োজন
          }
          
          if (data.timings && data.currentCity) {
            // ক্যাশেড টাইমিংস লোড (অফলাইন মোডের জন্য)
  ...
  useEffect(() => {
    ...
    const saveData = () => {
      ...
      localStorage.setItem('ramadan-ultra-v2', JSON.stringify(data));
    };
    
    const debounce = setTimeout(saveData, 1000);
    return () => clearTimeout(debounce);
  }, [favorites, method, school, unit, soundEnabled, showCountdown, autoRefresh, hijriAdjustment, currentCity, cityEn, timings, lastUpdated, isFirstLoad]);
  ...
  useEffect(() => {
    ...
    // বর্তমান সময়ের পরের নামাজ খুঁজি
    let next = null;
    ...
    // যদি কোন নামাজ না পাওয়া যায়, আগামীকালের ফজর
  ...
  const fetchSuggestions = (query) => {
    ...
    const filtered = POPULAR_CITIES
      .filter(city => 
        city.bn.includes(bnQuery) || 
        city.en.toLowerCase().includes(enQuery)
      )
      .map(city => ({ 
        bn: city.bn, 
        en: city.en, 
  ...
  // টাইমিংস ফেচ (রিট্রাই সহ)
  const fetchTimings = async (searchCityBn = city, searchCityEn = cityEn, isAutoRefresh = false) => {
      ...
      try {
        ...
        if (data.data.date && data.data.date.hijri) {
          ...
          setHijriDate({
            ...
            monthAr: ARABIC_MONTHS[parseInt(hijri.month.number) - 1],
            year: hijri.year,
          ...
          // রোজা সংখ্যা
          if (parseInt(hijri.month.number) === 9) { // রমজান
            setRozaCount(parseInt(hijri.day));
          } else {
            setRozaCount(0);
          }
        }
        ...
        // সাহরী ও ইফতার
        setSeharIftar({
          sehar: validatedTimings.Fajr,
          iftar: validatedTimings.Maghrib
        });
        
        // ওয়েদার (যদি লেট/লন থাকে)
        if (lat && lon) {
        ...
        if (retryCount === maxRetries) {
          ...
          // অফলাইন মোডে ক্যাশেড ডাটা ব্যবহার
          if (history.length > 0) {
    ...
    try {
      ...
      if (weatherData.current_weather) {
        setWeather({
          ...
          wind: Math.round(weatherData.current_weather.windspeed / 3.6), // km/h to m/s
          feelsLike: Math.round(weatherData.current_weather.temperature - 2 + Math.random() * 4),
  ...
  const toggleFavorite = () => {
    ...
    setFavorites(prev => {
      ...
      if (exists) {
        addNotification('info', `${currentCity} পছন্দের তালিকা থেকে সরানো হয়েছে`);
        return prev.filter(f => f.name !== currentCity);
      } else {
        addNotification('success', `${currentCity} পছন্দের তালিকায় যোগ করা হয়েছে`);
  ...
  const share = async () => {
    ...
    const ramadanText = rozaCount > 0 ? `\n🌙 রমজান: ${toBengaliNumber(rozaCount)}তম রোজা` : '';
    
    const text = `🕌 রমজান আল্ট্রা - ${currentCity}
        ...
        <div className="container">
          ...
          <div className="hero">
            ...
            <div className="hero-time">
              {toBengaliNumber(currentTime.getHours().toString().padStart(2, '0'))}:
              {toBengaliNumber(currentTime.getMinutes().toString().padStart(2, '0'))}:
              {toBengaliNumber(currentTime.getSeconds().toString().padStart(2, '0'))}
            </div>
            {accuracy && (
            ...
            <>
              ...
              {rozaCount > 0 && (
                <div style={{ textAlign: 'center', marginBottom: '20px' }}>
                  <div className="ramadan-badge">
                    <Award size={24} />
                    <span>
                      {toBengaliNumber(rozaCount)} তম রোজা · রমজান {toBengaliNumber(hijriDate?.day || '')}
                    </span>
                  </div>
                </div>
              )}
              ...
              {showCountdown && (
                <div className="countdown-grid">
                  <Card className="countdown-card" glow={countdowns.sehar?.seconds < 300}>
                  ...
                  <Card className="countdown-card" glow={countdowns.iftar?.seconds < 300}>
                    <div className="countdown-label">
              ...
              {/* পরবর্তী নামাজ */}
              {nextPrayer && (
                <Card className="next-banner mb-5" glow={nextPrayer.diffMinutes < 5}>
              ...
              {qibla && (
                <Card className="qibla-wrap mb-5">
                  <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                    <Compass size={24} style={{ color: 'var(--emerald-light)' }} />
                    <div>
                      <div style={{ fontSize: '14px', color: 'var(--text-muted)' }}>কিবলা দিক</div>
                      <div className="qibla-direction">{toBengaliNumber(qibla)}°</div>
                    </div>
                    <div style={{ marginLeft: 'auto' }}>
                      <Navigation size={24} style={{ transform: `rotate(${qibla}deg)`, color: 'var(--gold)' }} />
                    </div>
                  </div>
                </Card>
              )}
              ...
              <div className="twin-grid">
                ...
                <Card className="main-card" glow={nextPrayer?.key === 'Maghrib'}>
                  <div className="mc-top">
                    <div>
                      <div className="mc-badge mc-badge-iftar">
                        <Sun size={14} /> ইফতার · মাগরিব
                      </div>
                      <div className="mc-time" style={{ color: 'var(--warning)' }}>
                        {fmt(timings.Maghrib)}
                      </div>
              ...
              <Card className="prayers-wrap mb-5">
                <div className="section-title">
                  <Layers size={18} /> নামাজের সময় - {currentCity}
                </div>
                <div className="prayers-grid">
                  {PRAYERS.map(p => (
                    ...
                    >
                      ...
                      <div className={`prayer-time ${nextPrayer?.key === p.key ? 'prayer-time-next' : ''}`}>
                        {fmt(timings[p.key])}
                      </div>
                    </div>
                  ))}
              ...
              <div className="actions">
                <Tooltip text={isFav ? "পছন্দের তালিকা থেকে সরান" : "পছন্দের তালিকায় যোগ করুন"}>
                ...
                <Tooltip text={showCountdown ? "কাউন্টডাউন বন্ধ করুন" : "কাউন্টডাউন চালু করুন"}>
                  <button className={`action-btn ${showCountdown ? 'action-btn-active' : ''}`} onClick={() => setShowCountdown(v => !v)}>
                  ...
                  <div className="settings-grid">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) => setHijriAdjustment(Number(e.target.value))}
                      >
                        <option value={-1}>-১ দিন</option>
                        <option value={0}>০ দিন (ডিফল্ট)</option>
                        <option value={1}>+১ দিন</option>
                      </select>
                    </div>
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) => setAutoRefresh(e.target.value === 'yes')}
                      >
                        <option value="no">বন্ধ</option>
                        <option value="yes">চালু (১৫ মিনিট)</option>
                      </select>
                    </div>
                  </div>
                  ...
                  <div className="fav-list">
                    {favorites.map((fav, index) => (
                      <div key={index} className="fav-item">
                        <div className="fav-name" onClick={() => loadFromFavorite(fav)}>
                          <MapPin size={18} style={{ color: 'var(--gold)' }} />
                          <div>
                            <div>{fav.name}</div>
                            {fav.lastVisited && (
                              <small style={{ color: 'var(--text-muted)' }}>
                                সর্বশেষ: {new Date(fav.lastVisited).toLocaleDateString('bn-BD')}
                              </small>
                            )}
                          </div>
                        ...
                        <button
                          ...
                          onClick={() => setFavorites(prev => prev.filter(f => f.name !== fav.name))}
                        >
                          <X size={16} />
                        </button>
                      </div>
          ...
          <Card className="info-wrap">
            <div className="info-inner">
              ...
              <div>
                <div className="info-title">রমজান আল্ট্রা</div>
                ...
                <div className="info-meta">
                  <span>আল-আধান API</span>
                  <span>·</span>
                  <span>{METHODS.find(m => m.id === method)?.name}</span>
                  <span>·</span>
                  <span>{SCHOOLS.find(s => s.id === school)?.name}</span>
                  <span>·</span>
                  <span>নির্মিত হয়েছে বাংলাদেশের জন্য</span>
                </div>
              </div>
            </div>
          </Card>
